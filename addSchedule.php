<div class="addTimeContainer" id="schedule-form">
  <button type="button" class="pull-right btn btn-xs exitForm"> <span class=" glyphicon glyphicon-remove" aria-hidden="true"></span></button>
  <form class="form-horizontal addTimeForm" method="post">
    <div class="form-group formAdd col-md-3 col-xs-7 col-sm-4">
      <label class="control-label " for="date">Kuupäev:</label>
      <input class="span2 workDate form-control" size="16" name="workDate" id="workDate" type="data" maxlength="8">
    </div>
    <div class="form-group formAdd col-md-3 col-xs-6 col-sm-4">
    ...
    <div class="form-group formAdd col-md-1 col-xs-6 col-sm-4">
    ...
    <div class="addSubmittButton pull-right">
    </div>
